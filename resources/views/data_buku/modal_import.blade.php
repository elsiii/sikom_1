    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content modal-content-demo">
            ...
            <div class="modal-footer">
                <button class="btn ripple btn-primary" type="button">Simpan Import</button>
                <button class="btn ripple btn-secondary" data-bs-dismiss="modal" type="submit">Submit</button>
            </div>
        </form>
        </div>
    </div>
